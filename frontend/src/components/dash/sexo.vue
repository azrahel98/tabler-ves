<template>
  <div class="rounded-lg bg-card text-card-foreground shadow-sm p-4 h-min">
    <div class="flex items-center gap-2 mb-4">
      ...
      <h3 class="text-base font-medium">Distribución por Género</h3>
    </div>
    ...
    <div class="space-y-4">
      <div class="relative">
        <div class="flex items-center justify-between mb-1">
          <div class="flex items-center gap-2">
            <div class="w-2.5 h-2.5 rounded-full bg-nexus-blue"></div>
            <span class="text-sm font-medium">Hombres</span>
          </div>
          <span class="text-sm font-semibold text-nexus-blue">{{ hombres }}</span>
        </div>
      ...
      <div class="relative">
        <div class="flex items-center justify-between mb-1">
          <div class="flex items-center gap-2">
            <div class="w-2.5 h-2.5 rounded-full bg-nexus-purple"></div>
            <span class="text-sm font-medium">Mujeres</span>
          </div>
          <span class="text-sm font-semibold text-nexus-purple">{{ mujeres }}</span>
        </div>
