<template>
  <aside
    :class="
      sidebarToggle
        ? 'translate-x-0 lg:w-[90px] px-0'
        : '-translate-x-full px-5'
    "
        ...
        <div>
          ...
          <ul class="mb-6 flex flex-col gap-1.5">
            <li>
              <router-link
                to="/dash"
                class="flex items-center gap-2.5 rounded-sm py-2 menu-item-inactive"
                :class="sidebarToggle ? 'justify-center px-0' : 'px-4'"
              >
                <LayoutDashboard class="size-5" />
                <span class="text-sm" :class="sidebarToggle ? 'lg:hidden' : ''"
                  >Dashboard</span
                >
              </router-link>
            </li>
