  ...
  <aside
    ...
    <div class="flex flex-col overflow-y-auto duration-300 mx-0 px-3 ease-linear no-scrollbar">
      <nav class="mt-5 py-2 lg:mt-9 px-0">
        <div>
          <h3 class="mb-4 text-body-tiny text-gray-400 dark:text-gray-500" :class="sidebarToggle ? 'lg:hidden' : ''">MENU</h3>
          ...
          <ul class="mb-6 flex flex-col gap-1.5">
            <li>
              <router-link to="/dash" class="flex items-center gap-2.5 rounded-sm py-2 menu-item-inactive" :class="sidebarToggle ? 'justify-center px-0' : 'px-4'">
                ...
                <span class="text-body-medium" :class="sidebarToggle ? 'lg:hidden' : ''">Dashboard</span>
              </router-link>
            </li>
            ...
            <li>
              <router-link
                ...
                <Users class="size-5" />
                <span class="text-body-medium" :class="sidebarToggle ? 'lg:hidden' : ''">Personal</span>
              </router-link>
            </li>
            ...
            <li>
              <router-link
                ...
                <span class="text-body-medium" :class="sidebarToggle ? 'lg:hidden' : ''">Organigrama</span>
              </router-link>
            </li>
            ...
            <li v-if="esAdmin">
              <router-link
                ...
                active-class="bg-primary/10 text-primary dark:bg-primary/20 dark:text-brand-300">
                <Shield class="size-5" />
                <span class="text-body-medium" :class="sidebarToggle ? 'lg:hidden' : ''">Sindicatos</span>
              </router-link>
            </li>
            ...
            <li v-if="esAdmin">
              <router-link
                ...
                <span class="text-body-medium" :class="sidebarToggle ? 'lg:hidden' : ''">Nuevo Vínculo</span>
              </router-link>
            </li>
            ...
            <li v-if="esAdmin">
              <router-link
                ...
                <span class="text-body-medium" :class="sidebarToggle ? 'lg:hidden' : ''">Usuarios</span>
              </router-link>
            </li>
            ...
            <li v-if="esAdmin">
              <router-link
                ...
                <span class="text-body-medium" :class="sidebarToggle ? 'lg:hidden' : ''">Comparar MEF</span>
              </router-link>
            </li>
            ...
            <li v-if="esAdmin">
              <router-link
                ...
                <span class="text-body-medium" :class="sidebarToggle ? 'lg:hidden' : ''">Calidad de Datos</span>
              </router-link>
            </li>
            ...
            <li v-if="esAdmin">
              <router-link
                ...
                active-class="bg-primary/10 text-primary dark:bg-primary/20 dark:text-brand-300">
                <FileUp class="size-5" />
                <span class="text-body-medium" :class="sidebarToggle ? 'lg:hidden' : ''">Carga Masiva</span>
              </router-link>
            </li>
            ...
            <li>
              <router-link
                ...
                active-class="bg-primary/10 text-primary dark:bg-primary/20 dark:text-brand-300">
                <Users class="size-5" />
                <span class="text-body-medium" :class="sidebarToggle ? 'lg:hidden' : ''">Perfil</span>
              </router-link>
            </li>
          </ul>
        </div>
        ...
        <div>
          <h3 class="mb-4 text-body-tiny text-gray-400 dark:text-gray-500" :class="sidebarToggle ? 'lg:hidden' : ''">CONFIGURACIÓN</h3>
          ...
          <ul class="mb-6 flex flex-col gap-1.5">
            <li>
              <router-link
                ...
                <span class="text-body-medium" :class="sidebarToggle ? 'lg:hidden' : ''">Contraseña</span>
              </router-link>
            </li>
          </ul>
        </div>
