  ...
  <div class="hidden lg:block">
    <div class="relative" ref="searchContainerRef">
      ...
      <input
        ...
        class="shadow-theme-xs focus:border-primary/40 focus:ring-primary/10 h-11 w-full rounded-lg border border-gray-100 bg-transparent py-2.5 pr-14 pl-12 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden xl:w-[430px] dark:border-white/6 dark:text-white/90" />
