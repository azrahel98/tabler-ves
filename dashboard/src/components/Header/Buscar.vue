      ...
      <Transition name="dropdown">
        <div
          ...
          <template v-if="isLoading">
            <div v-for="i in 3" :key="i" class="px-4 py-3 border-b border-gray-100 dark:border-gray-800">
              <div class="h-3 w-3/4 rounded bg-gray-200 dark:bg-gray-700 animate-pulse mb-1.5"></div>
              <div class="h-2.5 w-1/3 rounded bg-gray-100 dark:bg-gray-800 animate-pulse"></div>
            </div>
          </template>
