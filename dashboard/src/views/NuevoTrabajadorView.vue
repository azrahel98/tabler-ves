...
const isStep2Valid = computed(() => {
  return (
    formData.plaza.codigo.trim().length > 0 &&
...
const onSubmitRegistro = async () => {
  ...
  const payload: NuevoTrabajadorPayload = {
    ...
    airshp: formData.plaza.codigo.trim(),
    documento: {
...
<template>
  <div class="space-y-6 max-w-7xl mx-auto pb-16">
    <div v-if="toastMessage" class="fixed bottom-5 right-5 z-50 transition-all duration-300 transform translate-y-0">
      ...
      >
        <span class="size-2 rounded-full shrink-0" :class="toastMessage.type === 'success' ? 'bg-emerald-500' : 'bg-rose-500'"></span>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 border-b border-border pb-4">
      <div class="space-y-1">
        ...
        <p class="text-xs text-muted-foreground pl-8">
          Registro integral de identidad, plaza AIRHSP, vínculo laboral y documento de ingreso.
        </p>
      </div>
    ...
    <div class="grid grid-cols-3 gap-2 sm:gap-4 select-none">
      ...
      >
        <div
          class="size-7 rounded-lg flex items-center justify-center font-bold text-xs shrink-0"
      ...
      >
        ...
        <div class="min-w-0 flex-1">
          <p class="text-xs font-semibold truncate">2. Vínculo y Plaza</p>
          <p class="text-[10px] text-muted-foreground truncate hidden sm:block">AIRHSP, área, cargo y régimen</p>
        </div>
      </button>
      ...
      <div class="xl:col-span-8 space-y-6">
        <Card v-show="currentStep === 1" class="space-y-4">
          ...
          <div class="p-3.5 rounded-xl bg-primary/5 border border-primary/20 space-y-3">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              ...
              <div class="flex items-center gap-2">
                ...
                <Button
                  ...
                  :disabled="isConsultandoReniec || formData.personal.dni.length !== 8"
                  @click="onConsultarReniec"
                >
            ...
            <p v-if="reniecSuccess" class="text-xs text-emerald-600 dark:text-emerald-400 font-medium flex items-center gap-1">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-3 gap-3.5 pt-1">
            <div class="space-y-1">
              ...
              <input
                v-model="formData.personal.nombre"
                type="text"
            ...
            <div class="space-y-1">
              ...
              <input
                v-model="formData.personal.apaterno"
                type="text"
            ...
            <div class="space-y-1">
              ...
              <input
                v-model="formData.personal.amaterno"
                type="text"
          ...
          <div class="grid grid-cols-1 sm:grid-cols-3 gap-3.5">
            <div class="space-y-1">
              ...
              <input
                v-model="formData.personal.nacimiento"
                type="date"
            ...
            <div class="space-y-1">
              ...
              <select
                v-model="formData.personal.sexo"
                class="w-full px-3 py-2 text-xs rounded-lg border border-border bg-card text-foreground focus:outline-hidden focus:border-primary"
              >
          ...
          <div class="border-t border-border/70 pt-3 space-y-3">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
              <div class="space-y-1">
                ...
                <input
                  v-model="formData.personal.telf"
                  type="text"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-3.5">
              <div class="space-y-1">
                ...
                <input
                  v-model="formData.personal.region"
                  type="text"
                  placeholder="LIMA"
                  class="w-full px-3 py-2 text-xs rounded-lg border border-border bg-card text-foreground focus:outline-hidden focus:border-primary"
                />
              ...
              <div class="space-y-1">
                ...
                <input
                  v-model="formData.personal.distrito"
                  type="text"
              ...
              <div class="space-y-1">
                ...
                <input
                  v-model="formData.personal.direccion"
                  type="text"
          ...
          <div class="flex items-center justify-end pt-3 border-t border-border">
            <Button
              ...
              @click="avanzarPaso"
            >
              <span>Continuar a Vínculo y Plaza</span>
        ...
        <Card v-show="currentStep === 2" class="space-y-4">
          <div class="flex items-center justify-between border-b border-border pb-3">
            <span class="text-sm font-bold text-foreground flex items-center gap-2">
              ...
              Asignación Laboral y Plaza AIRHSP
            </span>
          ...
          <div class="p-3.5 rounded-xl bg-card border border-border space-y-3">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              <div class="space-y-0.5">
                <span class="text-xs font-semibold text-foreground flex items-center gap-1.5">
                  ...
                  Selección de Plaza AIRHSP
                </span>
                <p class="text-[11px] text-muted-foreground">
                  Elige una plaza de la lista de vacantes disponibles o digita el código de plaza.
                </p>
              </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3.5 pt-1">
              <div class="space-y-1">
                <label class="text-xs font-semibold text-foreground">Código de Plaza AIRHSP *</label>
                <div class="relative">
                  <input
                    v-model="formData.plaza.codigo"
                    type="text"
              ...
              <div class="space-y-1">
                ...
                <select
                  v-model="formData.plaza.regimen"
                  class="w-full px-3 py-2 text-xs rounded-lg border border-border bg-card text-foreground focus:outline-hidden focus:border-primary"
                >
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
            ...
            <div class="space-y-1">
              ...
              <select
                v-model="formData.plaza.cargoId"
                class="w-full px-3 py-2 text-xs rounded-lg border border-border bg-card text-foreground focus:outline-hidden focus:border-primary"
              >
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
            <div class="space-y-1">
              ...
              <input
                v-model.number="formData.plaza.sueldo"
                type="number"
                step="0.01"
                min="0"
                placeholder="0.00"
            ...
            <div class="space-y-1">
              ...
              <input
                v-model="formData.plaza.cargoEstructural"
                type="text"
        ...
        <Card v-show="currentStep === 3" class="space-y-4">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-3 gap-3.5">
            <div class="space-y-1">
              ...
              <select
                v-model="formData.documento.tipoDocumento"
                class="w-full px-3 py-2 text-xs rounded-lg border border-border bg-card text-foreground focus:outline-hidden focus:border-primary"
              >
            ...
            <div class="space-y-1">
              ...
              <input
                v-model.number="formData.documento.numeroDocumento"
                type="number"
                min="1"
                placeholder="105"
            ...
            <div class="space-y-1">
              ...
              <input
                v-model.number="formData.documento.añoDocumento"
                type="number"
                min="1990"
                max="2050"
                class="w-full px-3 py-2 text-xs font-mono font-medium rounded-lg border border-border bg-card text-foreground focus:outline-hidden focus:border-primary"
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
            <div class="space-y-1">
              ...
              <input
                v-model="formData.documento.fecha"
                type="date"
                class="w-full px-3 py-2 text-xs font-mono rounded-lg border border-border bg-card text-foreground focus:outline-hidden focus:border-primary"
              />
            </div>
            ...
            <div class="space-y-1">
              ...
              <input
                v-model="formData.documento.fechaValida"
                type="date"
                class="w-full px-3 py-2 text-xs font-mono rounded-lg border border-border bg-card text-foreground focus:outline-hidden focus:border-primary"
              />
            </div>
          ...
          <div class="space-y-1">
            ...
            <textarea
              v-model="formData.documento.descripcion"
              rows="3"
          ...
          <div class="space-y-2 text-xs">
            ...
            <div class="grid grid-cols-2 gap-2 border-y border-border/60 py-2">
              <div>
                ...
                <span class="font-mono text-foreground">{{ formData.personal.nacimiento ? formatDate(formData.personal.nacimiento) : '-' }}</span>
              </div>
              <div>
            ...
            <div class="grid grid-cols-2 gap-2 border-y border-border/60 py-2">
              <div>
                <span class="text-[10px] text-muted-foreground uppercase font-bold block">Plaza AIRHSP</span>
                <span class="font-mono font-bold text-foreground">{{ formData.plaza.codigo || '-' }}</span>
              </div>
              <div>
            ...
            <div>
              <span class="text-[10px] uppercase font-bold text-muted-foreground tracking-wider block">Documento de Sustento</span>
              <p class="font-medium text-foreground truncate">
                {{ tipoDocSeleccionadoNombre }} N° {{ formData.documento.numeroDocumento }}-{{ formData.documento.añoDocumento }}
              </p>
          ...
          <div class="pt-2 border-t border-border">
            <div class="flex items-center gap-2">
              <span
                ...
                :class="isStep1Valid && isStep2Valid && isStep3Valid ? 'bg-emerald-500 animate-pulse' : 'bg-amber-500'"
              ></span>
              <span class="text-[11px] font-medium" :class="isStep1Valid && isStep2Valid && isStep3Valid ? 'text-emerald-600 dark:text-emerald-400' : 'text-amber-600 dark:text-amber-400'">
                {{ isStep1Valid && isStep2Valid && isStep3Valid ? 'Formulario completo y listo para registrar' : 'Completa todos los campos obligatorios' }}
              </span>
            </div>
          </div>
        </Card>
          ...
          <div class="flex items-center justify-between border-b border-border pb-3">
            <div class="space-y-0.5">
              ...
              <p class="text-xs text-muted-foreground">
                Selecciona una plaza AIRHSP en estado vacante para autocompletar el vínculo.
              </p>
            </div>
            <button
              type="button"
