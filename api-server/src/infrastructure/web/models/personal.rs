...
#[derive(Serialize, Deserialize, Validate, Clone, ts_rs::TS)]
#[ts(export)]
pub struct Perfil {
...
#[derive(Debug, Serialize, Deserialize, FromRow, Validate, Clone, ts_rs::TS)]
#[ts(export)]
...
#[derive(Debug, Serialize, Deserialize, Validate, Clone, ts_rs::TS)]
#[ts(export)]
