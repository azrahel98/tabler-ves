...
use crate::domain::entities::personal::{Perfil, PerfilInput, Persona, Vinculos};
use base64::Engine;
use chrono::NaiveDate;
use reqwest::Client;
use serde_json::Value;
use crate::infrastructure::db::repositories::personal_repo;
use sqlx::MySqlPool;
...
use crate::domain::entities::audit::AuditContext;
use crate::application::usecases::audit_service;
use serde_json::json;
