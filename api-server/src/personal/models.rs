...
pub struct Vinculos {
    ...
    #[sqlx(skip)]
    pub eventos: Vec<EventoVinculoDetalle>,
    #[sqlx(default)]
    pub origen: String,
}
#[derive(Debug, Serialize, Deserialize, FromRow, Clone)]
pub struct SunatVinculo {
    pub id: i32,
    pub dni: String,
    pub fecha_inicio: NaiveDate,
    pub fecha_cese: Option<NaiveDate>,
...
pub struct EventoVinculoPayload {
    ...
    pub nuevo_cargo_id: Option<i32>,
    pub documento_inicio: Option<Documento>,
    pub documento_salida: Option<Documento>,
    pub mismo_documento: Option<bool>,
    pub estado: Option<String>,
}

#[derive(Debug, Serialize, Deserialize, FromRow, Clone)]
pub struct EventoVinculoDetalle {
    pub id: i32,
    pub vinculo_id: i32,
    pub tipo_evento: String,
    pub estado: Option<String>,
    pub nueva_area_id: Option<i32>,
    pub nueva_area: Option<String>,
    pub nuevo_cargo_id: Option<i32>,
    pub nuevo_cargo: Option<String>,
    pub doc_inicio_id: Option<i32>,
